...
describe('Counter', () => {
    ...
    it('must have right placeholder', () => {
        render(<Counter placeHolder='Add' maxValue={5} updateCart={mockFunction} value={0}/>);
    ...
    it('must have right value', () => {
        render(<Counter placeHolder='Add' maxValue={5} updateCart={mockFunction} value={2}/>);
    ...
    it('must have not show add button when value is equal to max value', () => {
        render(<Counter placeHolder='Add' maxValue={5} updateCart={mockFunction} value={5}/>);
        const ele = screen.queryByTestId('add');
        expect(ele).not.toBeInTheDocument();
    });
    it('must show delete button if the value is equal to 1', () => {
        render(<Counter placeHolder='Add' maxValue={5} updateCart={mockFunction} value={1}/>);
    ...
    it('must show add and minus button if the value is let than max value but more than 1', () => {
        render(<Counter placeHolder='Add' maxValue={5} updateCart={mockFunction} value={3}/>);
